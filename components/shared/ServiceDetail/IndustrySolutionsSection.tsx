                    ...
                    {data.items.map((industry, index) => (
                        <div
                            ...
                            onMouseEnter={(e) => {
                                ...
                                e.currentTarget.style.boxShadow = '0 10px 40px rgba(6, 182, 212, 0.12), 0 6px 20px rgba(139, 92, 246, 0.1), inset 0 1px 1px rgba(255, 255, 255, 0.65)';
                            }}
                            onMouseLeave={(e) => {
                                e.currentTarget.style.border = '1px solid rgba(255, 255, 255, 0.25)';
                                e.currentTarget.style.boxShadow = '0 8px 32px rgba(0, 0, 0, 0.1), inset 0 1px 1px rgba(255, 255, 255, 0.6)';
                            }}
                        >
                            ...
                            <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-4 transition-all duration-300 relative z-10"
                                style={{
                            ...
                            <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-cyan-600 transition-colors relative z-10">
                                {industry.title}
                            </h3>
                            <p className="text-sm text-gray-700 leading-relaxed font-semibold relative z-10">

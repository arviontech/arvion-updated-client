...
const OptimizedNavbar = ({ services, navItems }: OptimizedNavbarProps) => {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 border-b border-white/20 transition-transform duration-300 ${
            ...
            <Link href="/" className="flex-shrink-0">
              <div className="relative px-3 sm:px-4 py-1.5 sm:py-2 bg-white/30 rounded-full shadow-sm overflow-hidden animate-shadow-pulse">
                <span
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, rgba(255,255,255,0.6) 0%, rgba(255,255,255,0.2) 50%, rgba(255,255,255,0.6) 100%)",
                    WebkitMask:
                ...
                <Image
                  src={logo}
                  alt="Arvion Tech - Premium Web Development Company"
                  width={140}
                  height={45}

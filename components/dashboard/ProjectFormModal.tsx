...
import { X, Upload, Trash2, Plus, Bold, Italic, List, ListOrdered } from 'lucide-react';
...
const ProjectFormModal = ({ isOpen, onClose, onSuccess, editProject }: ProjectFormModalProps) => {
    ...
    // Update editor content when editing project
    useEffect(() => {
        if (editor && editProject) {
            editor.commands.setContent(editProject.description);
        }
    }, [editor, editProject]);
            ...
            <div className="bg-white rounded-2xl max-w-4xl w-full my-8">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto">
                    ...
                    <div>
                        ...
                        <div className="border border-gray-200 rounded-lg overflow-hidden">
                            ...
                            <div className="flex items-center gap-1 p-2 border-b border-gray-200 bg-gray-50">
                                <button
                                    ...
                                    className={`px-3 py-2 text-sm font-bold rounded hover:bg-gray-200 ${editor?.isActive('heading', { level: 1 }) ? 'bg-gray-300' : ''}`}
                                >
                                    H1
                                </button>
                                <button
                                    ...
                                    className={`px-3 py-2 text-sm font-bold rounded hover:bg-gray-200 ${editor?.isActive('heading', { level: 2 }) ? 'bg-gray-300' : ''}`}
                                >
                                    H2
                                </button>
                                <button
                                    ...
                                    className={`px-3 py-2 text-sm font-bold rounded hover:bg-gray-200 ${editor?.isActive('heading', { level: 3 }) ? 'bg-gray-300' : ''}`}
                                >
                                    H3
                                </button>
                        ...
                        <p className="text-xs text-gray-500 mt-1">Use the toolbar to format your text with bold, italic, lists, etc.</p>
                    </div>

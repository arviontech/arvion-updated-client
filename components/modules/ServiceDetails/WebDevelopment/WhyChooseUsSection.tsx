            ...
            <div className="relative max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 leading-tight">
                        ...
                        <span className="bg-gradient-to-r from-cyan-500 to-violet-600 bg-clip-text text-transparent">Web Dev Domination</span>
                    </h2>
                    <p className="mt-4 text-gray-600 max-w-3xl mx-auto font-semibold">

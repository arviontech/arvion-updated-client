                ...
                <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-center">
                        ...
                        <nav className="flex items-center gap-3 text-sm font-medium text-gray-500 mb-8">
                            ...
                            <span className="text-gray-300">/</span>
                            <span className="bg-gradient-to-r from-cyan-600 to-violet-600 bg-clip-text text-transparent px-3 py-1 rounded-full text-xs tracking-wide font-bold">AI & MACHINE LEARNING</span>
                        </nav>

                        {/* Main Heading */}
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-[1.15] tracking-tight">
                            Intelligent Solutions <br className="hidden lg:block" />
                            ...
                            <span className="text-3xl sm:text-4xl lg:text-5xl text-gray-800 font-semibold mt-2 block">
                                to Automate, Predict, and Transform Your Business
                            </span>
                        </h1>

                        {/* Description */}
                        <p className="text-lg text-gray-600 mb-10 leading-relaxed max-w-2xl">
                            We build custom AI solutions including intelligent chatbots, RAG applications, predictive analytics, and machine learning models that drive efficiency and innovation.
                        </p>

                ...
                <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="lg:col-span-7 flex flex-col justify-center">
                        ...
                        <nav className="flex items-center gap-3 text-sm font-medium text-gray-500 mb-8">
                            ...
                            <span className="text-gray-300">/</span>
                            <span className="bg-gradient-to-r from-cyan-600 to-violet-600 bg-clip-text text-transparent px-3 py-1 rounded-full text-xs tracking-wide font-bold">CLOUD SOLUTIONS</span>
                        </nav>

                        {/* Main Heading */}
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-[1.15] tracking-tight">
                            Scalable, Secure <br className="hidden lg:block" />
                            ...
                            <span className="text-3xl sm:text-4xl lg:text-5xl text-gray-800 font-semibold mt-2 block">
                                for Modern Businesses Ready to Scale
                            </span>
                        </h1>

                        {/* Description */}
                        <p className="text-lg text-gray-600 mb-10 leading-relaxed max-w-2xl">
                            We architect, deploy, and manage cloud solutions on AWS, Azure, and Google Cloud that reduce costs, improve performance, and enable your business to scale effortlessly.
                        </p>
                        ...
                        <div className="relative rounded-2xl overflow-hidden p-2"
                            ...
                            <div className="absolute -bottom-6 -left-6 p-4 rounded-xl flex items-center gap-3"
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-gray-900">Multi-Cloud</p>
                                </div>
                            </div>
                        </div>
                    </div>

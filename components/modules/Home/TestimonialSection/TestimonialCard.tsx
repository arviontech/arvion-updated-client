...
const TestimonialCard = ({ testimonial, index = 0 }: TestimonialCardProps) => {
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 rounded-2xl -z-[9]"
        style={{
          background:
      ...
      {/* Review Text */}
      <p
        className="text-gray-800 leading-relaxed italic mb-6 relative z-10 font-semibold"
        style={{
          textShadow:
      ...
      >
        <div
          className="relative w-12 h-12 rounded-full overflow-hidden bg-gray-100 flex-shrink-0"
          style={{
            background: "rgba(255, 255, 255, 0.3)",
            backdropFilter: "blur(5px)",
            WebkitBackdropFilter: "blur(5px)",
        ...
        <div>
          <h4
            className="font-bold text-gray-900 group-hover:text-cyan-600 transition-colors"
            style={{
